            ...
            <div class="row">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-3">
                                    <div class="p-3 border border-dashed rounded">
                                        <div class="mb-1 fs-12 text-muted">Awaiting</div>
                                ...
                                <div class="col-lg-3">
                                    <div class="p-3 border border-dashed rounded">
                                        <div class="mb-1 fs-12 text-muted">Completed</div>
                                ...
                                <div class="col-lg-3">
                                    <div class="p-3 border border-dashed rounded">
                                        <div class="mb-1 fs-12 text-muted">Rejected</div>
                                ...
                                <div class="col-lg-3">
                                    <div class="p-3 border border-dashed rounded">
                                        <div class="mb-1 fs-12 text-muted">Revenue</div>
                ...
                <div class="col-xxl-4">
                    <div class="overflow-hidden card stretch stretch-full">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="gap-3 hstack">
                                    <div class="p-2 rounded avatar-image avatar-lg">
                        ...
                        <a href="javascript:void(0);"
                            class="py-4 text-center card-footer fs-11 fw-bold text-uppercase">Full Details</a>
                    </div>
                </div>
                <!-- [Total Sales] end !-->
                <!-- [Mini] start -->
                <div class="col-lg-4">
                    <div class="mb-4 card stretch stretch-full">
                        ...
                        <div class="gap-4 card-body d-flex align-items-center justify-content-between">
                    ...
                    <div class="card stretch stretch-full">
                        ...
                        <div class="card-body custom-card-action">
                            ...
                            <div class="row g-2">
                                <div class="col-4">
                                    <a href="javascript:void(0);"
                                        class="gap-2 p-2 border border-dashed rounded hstack border-gray-5">
                ...
                <div class="col-xxl-8">
                    <div class="card stretch stretch-full">
                                ...
                                <table class="table mb-0 table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="bg-gray-200 badge text-dark">Sent</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="bg-gray-200 badge text-dark">New</span>
                                            </td>
                                            <td>11/06/2023 10:53</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="bg-gray-200 badge text-dark">Returning</span>
                                            </td>
                                            <td>11/06/2023 10:53</td>
                                            <td>
                        ...
                        <div class="card-footer">
                            <ul class="gap-2 mb-0 list-unstyled d-flex align-items-center pagination-common-style">
                                <li>
                ...
                <div class="col-xxl-4">
                    <div class="card stretch stretch-full">
                        ...
                        <div class="card-body">
                            <!--! BEGIN: [Events] !-->
                            <div class="p-3 mb-3 border border-dashed rounded-3">
                                <div class="d-flex justify-content-between">
                                    <div class="gap-3 d-flex align-items-center">
                                        <div
                                            ...
                                            <span class="mb-1 fs-18 fw-bold d-block">20</span>
                                            <span class="fs-10 fw-semibold text-uppercase d-block">Dec</span>
                                        </div>
                                        <div class="text-dark">
                                            <a href="javascript:void(0);" class="mb-2 fw-bold text-truncate-1-line">React
                                                Dashboard Design</a>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="gap-3 d-flex align-items-center">
                                        <div
                                            ...
                                            <span class="mb-1 fs-18 fw-bold d-block">30</span>
                                            <span class="fs-10 fw-semibold text-uppercase d-block">Dec</span>
                                        </div>
                                        <div class="text-dark">
                                            <a href="javascript:void(0);" class="mb-2 fw-bold text-truncate-1-line">Admin
                                                Design Concept</a>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="gap-3 d-flex align-items-center">
                                        <div
                                            ...
                                            <span class="mb-1 fs-18 fw-bold d-block">17</span>
                                            <span class="fs-10 fw-semibold text-uppercase d-block">Dec</span>
                                        </div>
                                        <div class="text-dark">
                                            <a href="javascript:void(0);"
                                                class="mb-2 fw-bold text-truncate-1-line">Standup Team Meeting</a>
                            ...
                            <!--! BEGIN: [Events] !-->
                            <div class="p-3 mb-2 border border-dashed rounded-3">
                                <div class="d-flex justify-content-between">
                                    <div class="gap-3 d-flex align-items-center">
                                        <div
                                            ...
                                            <span class="mb-1 fs-18 fw-bold d-block">25</span>
                                            <span class="fs-10 fw-semibold text-uppercase d-block">Dec</span>
                                        </div>
                                        <div class="text-dark">
                                            <a href="javascript:void(0);" class="mb-2 fw-bold text-truncate-1-line">Zoom
                                                Team Meeting</a>
                        ...
                        <a href="javascript:void(0);"
                            class="py-4 text-center card-footer fs-11 fw-bold text-uppercase">Upcomming Schedule</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-4">
                    <div class="card stretch stretch-full">
                        ...
                        <a href="javascript:void(0);"
                            class="text-center card-footer fs-11 fw-bold text-uppercase">Upcomming Projects</a>
                    </div>
                </div>
                <!--! END: [Project Status] !-->
                <!--! BEGIN: [Team Progress] !-->
                <div class="col-xxl-4">
                    <div class="card stretch stretch-full">
                        ...
                        <div class="card-body custom-card-action">
                            <div class="p-3 mb-3 border border-dashed hstack justify-content-between rounded-3">
                                <div class="gap-3 hstack">
                                    <div class="avatar-image">
                            ...
                            <div class="p-3 mb-2 border border-dashed hstack justify-content-between rounded-3">
                                <div class="gap-3 hstack">
                                    <div class="avatar-image">
                        ...
                        <a href="javascript:void(0);"
                            class="text-center card-footer fs-11 fw-bold text-uppercase">Update 30 Min Ago</a>
                    </div>
                </div>
                <!--! END: [Team Progress] !-->
            </div>
