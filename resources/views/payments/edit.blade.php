    ...
    <main class="nxl-container">
        <div class="nxl-content">
            ...
            <div class="main-content">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="card-body" method="POST" action="{{ route('payments.update', $payment->id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="card-body lead-status">
                                    <div class="mb-3 d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0 fw-bold me-4">
                                            <span class="mb-2 d-block">Edit Payment :</span>
                                        </h5>
                                    </div>
                                    <div class="row">
                                        <div class="my-2 col-md-4">
                                            <label class="fw-semibold">PI #</label>
                                            <input type="text" class="form-control"
                                                value="{{ $payment->transaction_no }}" readonly>
                                        </div>
                                        <div class="my-2 col-md-4">
                                            <label class="fw-semibold">Vendor</label>
                                            <input type="text" class="form-control"
                                                value="{{ $payment->counterparty->name ?? '' }}" readonly>
                                        </div>
                                        <div class="my-2 col-md-4">
                                            <label class="fw-semibold">Account</label>
                                            <input type="text" class="form-control"
                                                value="{{ $payment->account->name ?? '' }}" readonly>
                                        </div>
                                        <div class="my-2 col-md-4">
                                            ...
                                            <select data-select2-selector="status" class="form-select" name="payment_term"
                                                ...
                                                @foreach ($paymentTerms as $key => $label)
                                                    <option data-bg="bg-primary" value="{{ $key }}" 
                                                        {{ $payment->payment_term == $key ? 'selected' : '' }}>
                                                        {{ $label }}
                                                    </option>
                                                @endforeach
                                            </select>
                                      ...
                                      <div class="my-2 col-md-4 payment-field payment-cheque" style="display:none;">
                                        ...
                                        <div class="my-2 col-md-4 payment-field payment-cheque" style="display:none;">
                                            ...
                                            <input type="date" name="cheque_date" value="{{ $payment->cheque_date }}" class="form-control">
                                        </div>
                                        <div class="my-2 col-md-4 payment-field payment-po" style="display:none;">
                                            <label class="fw-semibold">PO #:</label>
                                            <input type="text" name="po_no" value="{{ $payment->po_no }}" class="form-control">
                                        </div>
                                        <div class="my-2 col-md-4 payment-field payment-po" style="display:none;">
                                            <label class="fw-semibold">PO Date:</label>
                                            <input type="date" name="po_date" value="{{ $payment->po_date }}" class="form-control">
                                        </div>
                                        <div class="my-2 col-md-4 payment-field payment-online_transfer"
                                            style="display:none;">
                                            <label class="fw-semibold">Online Transfer Date:</label>
                                            <input type="date" name="online_transfer_date" value="{{ $payment->online_transfer_date }}" class="form-control">
                                        </div>
                                        <div class="my-2 col-md-4">
