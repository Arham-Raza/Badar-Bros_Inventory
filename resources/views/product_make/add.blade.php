        ...
        <div class="main-content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <form class="card-body" method="POST" action="{{ route('product-makes.store') }}">
                        @csrf
                        <div class="card stretch stretch-full">
                            <div class="card-body lead-status">
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0 fw-bold me-4">
                                        <span class="mb-2 d-block">Add Make :</span>
                                    </h5>
                                </div>
                                <div class="row">
                                    <div class="my-2 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="nameInput" placeholder="Make Name" required>
                                        </div>
                                    </div>
                                    <div class="my-2 col-md-6">
