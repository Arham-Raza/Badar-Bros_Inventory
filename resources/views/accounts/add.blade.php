...
@section('content')
                                ...
                                <div class="card-body lead-status">
                                    <div class="mb-3 d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0 fw-bold me-4">
                                            <span class="mb-2 d-block">Add Account :</span>
                                        </h5>
                                    </div>
                                    <div class="row">
                                        <div class="my-2 col-md-6">
                                            <label for="typeInput" class="fw-semibold">Account Type: </label>
                                            <select data-select2-selector="status" name="account_type" class="form-control"
                                        ...
                                        <div id="customerSupplierFields" style="display:none;">
                                            ...
                                            <div class="my-2 col-md-6">
                                                ...
                                                <input type="text" name="mobile2" class="form-control"
                                                    id="mobile2Input" placeholder="Mobile 2">
                                            </div>
                                            <div class="my-2 col-md-6">
                                            ...
                                            <div class="my-2 col-md-6">
                                                ...
                                                <textarea name="address" class="form-control" id="addressInput" placeholder="Address"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-2 col-md-6">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            Inputmask("99999-9999999-9").mask("#cnicInput");
            Inputmask("0399-9999999").mask("#mobile1Input");
            Inputmask("0399-9999999").mask("#mobile2Input");
            Inputmask("0399-9999999").mask("#whatsappInput");
            // Inputmask("\\+\\92-999-9999999").mask("#whatsappInput");
        });
    </script>
@endsection
